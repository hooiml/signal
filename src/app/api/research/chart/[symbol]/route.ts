...
import { fetchYahooResearchChart } from '@/lib/research/yahoo-research';
    ...
    try {
        ...
        return NextResponse.json({
            ...
            data: {
                ...
                chart: await fetchYahooResearchChart(symbol, researchMarket, '5y'),
            },
        });
    } catch (error) {
        return NextResponse.json({ success: false, error: error instanceof Error ? error.message : 'Chart history unavailable.' }, { status: 502 });
    }
};
