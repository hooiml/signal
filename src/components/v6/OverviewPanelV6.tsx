...
const SnapshotMetric = ({ label, value, themeClasses }: {
    ...
    <div className="min-w-0">
        ...
        <dd className={'mt-0.5 text-xs font-semibold leading-4 ' + themeClasses.textPrimary} title={value}>{value}</dd>
    </div>
);
                ...
                <section className={'flex min-h-[230px] flex-col items-center justify-center rounded-lg border p-5 text-center backdrop-blur-md transition-colors duration-300 ' + themeClasses.panel}>
                    ...
                    >
                        <div className={'grid size-[74px] place-items-center rounded-full transition-colors duration-300 ' + themeClasses.ringInner}>
                            ...
                            <span className={'-mt-5 text-[9px] font-semibold ' + themeClasses.textSecondary}>checks</span>
                        </div>
                    </div>
                    <span className={'mt-3 rounded-full px-3 py-1 text-[11px] font-bold ' + themeClasses.statusSurface + ' ' + getActionToneV6(action, theme)}>{action}</span>
                    <p className={'mt-3 max-w-[180px] text-[11px] leading-4 ' + themeClasses.textMuted}>
