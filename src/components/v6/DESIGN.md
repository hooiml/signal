...
- Research uses `Watchlist | Discovery | Picker | Compare | Calendar | Alerts` as its leading display labels while retaining the corresponding internal workspace identifiers. Workspace changes update the query string without discarding unrelated deep-link context.
