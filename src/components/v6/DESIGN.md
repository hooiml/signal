...
- The story trust strip is the single compact orientation summary and keeps the prior-score comparison attached to the current composite score. A visible Why this score section follows the story and keeps score history beside contribution-ranked weighted evidence with inline prior-driver comparisons.
...
- The market screen opens as a concise view of current conditions rather than a scorecard. Its fixed reading order is: story headline and trust strip with inline score comparison, three evidence chapters, Why this score with inline driver comparisons, forward scenarios, non-scored market context, alerts, then terms, trust, and methodology.
...
- On narrow screens the reading order remains headline and trust strip, chapters, Why this score, scenarios, context, alerts, terms, and details. Score and driver comparisons stack beneath their current values; no narrative panel may require horizontal scrolling.
