...
export const MarketContextV6 = ({ context, theme }: { context: MarketContext; theme: ResearchThemeV6 }) => {
    ...
    return (
        <details className={'group overflow-hidden rounded-lg border ' + t.panelSolid} aria-labelledby="market-context-title" data-testid="market-context" data-surface-tier="utility">
