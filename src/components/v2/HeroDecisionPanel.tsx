...
export const HeroDecisionPanel = ({ signal, mode, isUpdating, error, theme }: HeroDecisionPanelProps) => {
    ...
    return (
        <section className={`relative overflow-hidden rounded-3xl border p-5 sm:p-7 ${themeClasses.panelStrong} ${heroAccent}`}>
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_0.72fr] lg:items-start">
                <div className="space-y-5">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className={`max-w-3xl text-base leading-7 sm:text-lg ${themeClasses.textMuted}`}>
                            {getReadExplainer(signal, mode)}
                        </p>
                        <div className="flex flex-wrap items-center gap-3">
                            <span className={`rounded-full border px-3 py-1 text-xs font-semibold uppercase tracking-[0.22em] ${tone.chip}`}>
                ...
                <div className={`rounded-3xl border p-5 shadow-[inset_0_1px_0_rgba(148,163,184,0.06)] ${themeClasses.panel}`}>
                    ...
                    <div className="mt-4 grid gap-3">
                        <div className={`rounded-2xl border px-4 py-3 ${scoreMovement.isUnchanged ? themeClasses.panelMuted : themeClasses.panelSoft}`}>
                        ...
                        <div className={`rounded-2xl border px-4 py-3 ${themeClasses.panelMuted}`}>
                            <div className={`text-[11px] font-semibold uppercase tracking-[0.22em] ${themeClasses.textSubtle}`}>Reliability</div>
                            <div className={`mt-2 inline-flex rounded-full border px-3 py-1 text-sm font-semibold ${reliabilityTone}`}>
                                {decisionReliability}
                            </div>
    ...
    return (
        <div className={`rounded-2xl border px-4 py-3 ${themeClasses.panelMuted}`}>
            ...
            <div className="relative mt-4 h-4 rounded-full bg-slate-800/40">
                ...
                <div
                    className={`absolute top-1/2 flex h-7 w-7 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border-2 text-[10px] font-bold shadow-lg ${markerTone}`}
