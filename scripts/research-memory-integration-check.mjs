...
const [page, wrapper, dashboard, dock, detail, adapter] = await Promise.all([
...
assert.match(dashboard, /<ResearchMemoryDockV7/, 'Research dashboard must own decision memory in source order');
